...
$string['addtranscriptionflavor'] = 'Neue Flavor-Option hinzufügen';
...
$string['batchupload_setting_desc'] = 'Wenn Sie diese Option aktivieren, stellt die Opencast-Instanz den Nutzer/innen eine separate Seite zur Verfügung, auf der sie Videos in einem Batch auf einmal hochladen können. Beachten Sie bitte, dass bei diesem Upload-Modus das Plugin local_chunkupload nicht funktioniert. Das heißt, die Dateigröße ist basierend auf Ihren Einstellungen begrenzt.<br /> Um zu vermeiden, dass die Upload-Warteschlange überfüllt wird, und um die Upload-Zeit zu verkürzen, wird empfohlen, die Option "Upload-Auftrag durch Cron begrenzen" zu erhöhen.<br /> Um Timeout-Fehler beim Hochladen von Videos zu vermeiden, empfiehlt es sich, die Timeout-Optionen in den folgenden Einstellungen Ihren Bedürfnissen entsprechend anzupassen: <br /> {$a->uploadtimeoutlink} <br /> {$a->toolopencastinstancelink}';
...
$string['batchuploadexplanation'] = 'In diesem Bereich können Sie mehrere Dateien auf einmal hochladen. <br /><strong>Hinweis</strong>: Bitte beachten Sie, dass der Batch-Video-Upload nur für Presenter-Flavors verfügbar ist.';
...
$string['emptyflavoroption'] = 'Bitte wählen Sie einen Servicetyp';
...
$string['enablechunkupload_desc'] = 'Wenn Chunkupload aktiviert ist, ist es möglich, Videos mit dem Chunkupload-Plugin hochzuladen';
$string['enableopencasteditorlink'] = 'Den Link zum Opencast Editor im Aktionsmenü anzeigen';
$string['enableopencasteditorlink_desc'] = 'Mit dieser Option wird im Blockinhalt und in der Blockübersicht eine Schaltfläche zum Öffnen des Opencast-Editors angezeigt.
 Die folgenden Einstellungen sowie die LTI-Anmeldedaten müssen ebenfalls konfiguriert werden.';
...
$string['error_duplicated_event_acl_change'] = 'Die Änderung der Sichtbarkeit für den duplizierte n Event ist fehlgeschlagen.
    Opencast-Task ({$a->taskid}) zur Änderung der Sichtbarkeit des duplizierten Events für den Kurs {$a->coursefullname}.';
$string['error_duplicated_event_id_not_ready'] = 'Der duplizierte Event ist noch nicht verfügbar.
    Task ({$a->taskid}) zur Änderung der Sichtbarkeit eines duplizierten Events für Kurs {$a->coursefullname} (ID: {$a->courseid}).';
...
$string['errorrestoremissingimportmode_body'] = 'Es gab ein Problem bei der Wiederherstellung des Kurses {$a->coursefullname} (ID: {$a->courseid}).
    Der Importmodus konnte nicht identifiziert werden, daher ist die Wiederherstellung fehlgeschlagen.';
...
$string['errorrestoremissingsourcecourseid_body'] = 'Es gab ein Problem bei der Wiederherstellung des Kurses {$a->coursefullname} (ID: {$a->courseid}).
    Die Quellkurs-ID konnte nicht gefunden werden.';
...
$string['importmodedesc'] = 'Um eine Variante für den Import von Videos in einen Kurs zu definieren, sollte ein Modus ausgewählt werden. Der Standardmodus ist "Duplizieren von Events", in dem eine neue Serie erstellt wird und Events in der Serie mit Hilfe eines Duplizierungsworkflows verfügbar sind. <br/>Beim Modus "Änderung der Zugriffsrechte" hingegen wird in allen Kursen dieselbe Serien-ID verwendet, aber die Zugriffsrechte für Serien und Ereignisse werden geändert, um den Zugriff von dem Kurs aus zu gewähren, der die Videos importiert.';
...
Bei ACL-Änderung als Importmodus wird die Seriennummer des zu importierenden Kurses verwendet, aber die ACL der Serie und ihrer Videos wird geändert, um den Zugriff innerhalb des neuen Kurses zu ermöglichen.<br /><strong>Hinweis:</strong> Beim Importmodus "ACL-Änderung" ist die Auswahl der Videos im Assistenten nicht vorgesehen.';
...
$string['maxtranscriptionupload'] = 'Maximale Anzahl der hochzuladenden Sets';
$string['maxtranscriptionupload_desc'] = 'Geben Sie an, wie viele Felder für Transkriptionen den Trainer/innen zum Hochladen zur Verfügung gestellt werden sollen. Wenn es nicht korrekt eingestellt ist, wird nur 1 Feldsatz bereitgestellt.';
...
$string['missingtranscriptionuploadparams'] = 'Die für das Hochladen der Transkription erforderlichen Parameter fehlen.';
...
$string['notranscriptionflavor'] = 'Unbekannte Servicetyp: {$a}';
...
$string['transcription_flavor_confirm_delete'] = 'Möchten Sie dieses Paar von Flavours-Optionen wirklich löschen?';
$string['transcription_flavor_delete'] = 'Flavor-Option-Paar löschen';
...
$string['transcriptionflavor_thead'] = 'Servicetyp';
$string['transcriptionflavorfield'] = 'Art des Transkriptionsdienstes';
$string['transcriptionflavors'] = 'Transkriptionsdienst-Typen (Flavors)';
$string['transcriptionflavors_desc'] = 'Dieser Diensttyp (Flavors) wird beim Hochladen von Transkriptionen als Auswahlmöglichkeit (Dropdown) angezeigt.
Es handelt sich um ein Schlüssel-Wert-Paar von Informationen, wobei die Schlüssel von opencast verwendet werden und die Werte menschenlesbare Informationen sind, die die Art des Transkriptionsdienstes beschreiben.<br>
  <b>(Mehrsprachige Filter)</b> Damit jeder Wert von <i>Drop Down (auswählen)</i> mit Hilfe von Filtern wie <a target="_blank" href="https://moodle.org/plugins/filter_multilang2">Multi-Language Content (v2)</a> übersetzt werden kann, sollte jeder Wert den vom Filter definierten Platzhalter enthalten, z.B. "{mlang en}Amberscript German{mlang}{mlang de}Amberscript Deutsch{mlang}".';
...
$string['transcriptionuploadfailed'] = 'Hochladen der Transkription fehlgeschlagen!';
$string['transcriptionuploadsuccessed'] = 'Die Transkription wurde hochgeladen.';
