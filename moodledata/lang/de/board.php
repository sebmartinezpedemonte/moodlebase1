...
/**
 * Strings for component 'board', language 'de', version '4.1'.
 *
 * @package     board
 * @category    string
...
$string['allowed_singleuser_modes_desc'] = 'Nutzung bestimmter Einzelnutzermodi erbauben bzw. verbieten. Dies hat keine Auswirkungen auf bereits bestehende Boards.';
...
$string['event_delete_column_desc'] = 'Nutzer/in \'{$a->userid}\' hat im Board die Spalte \'{$a->columnid}\' gelöscht.';
...
$string['event_update_column_desc'] = 'Nutzer/in \'{$a->userid}\' hat im Board die Spalte \'{$a->columnid}\' zu \'{$a->name}\' aktualisiert.';
...
$string['modulename_help'] = 'Board ist eine Aktivität in Moodle, mit der Trainer/innen eine neue "Postit"-Tafel erstellen können.';
...
$string['rate_remove_note_text'] = 'Möchten Sie wirklich die Bewertung von diesem Betrag entfernen?';
