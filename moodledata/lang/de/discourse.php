...
/**
 * Strings for component 'discourse', language 'de', version '4.1'.
 *
 * @package     discourse
 * @category    string
...
$string['deletealluserdata'] = 'Alle Nutzerdaten löschen';
...
$string['discourse:potentialparticipant'] = 'DisKurs als Teilnehmer/in beitreten';
$string['discourse:switchphase'] = 'Diskursphase umschalten';
$string['discourse:viewallgroups'] = 'Alle Gruppen anzeigen';
$string['discourse:viewgroupparticipants'] = 'Alle Gruppenteilnehmer/innen anzeigen';
$string['editsubmission'] = 'Einreichung bearbeiten';
$string['errfilloutfield'] = 'Dieses Feld bitte ausfüllen';
$string['group'] = 'Gruppe';
$string['groupfor'] = 'Gruppe für {$a}';
$string['groupingdescription'] = 'Gruppierung für die DisKursaktivität {$a}';
...
$string['groupparticipants'] = 'Teilnehmer/innen';
...
$string['phasecompletion'] = 'Phasenabschluss';
...
$string['privacy:metadata:discourse_participants'] = 'Enthält die Gruppen aller Teilnehmer/innen im DisKurs.';
$string['privacy:metadata:discourse_participants:discourse'] = 'ID des DisKurses der Person';
$string['privacy:metadata:discourse_participants:groupids'] = 'IDs der DisKursgruppen der Person';
$string['privacy:metadata:discourse_participants:userid'] = 'Nutzer-ID der Person';
$string['privacy:metadata:discourse_submissions'] = 'Enthält Informationen zu allen DisKurseinreichungen.';
...
$string['submissionfaileddoubled'] = 'Einreichung fehlgeschlagen. Ein anderes Gruppenmitglied hat bereits eine Einreichung abgegeben.';
...
$string['toggleallgroups'] = 'Alle Gruppen in Phase {$a} umschalten';
$string['updated'] = 'Aktualisiert am';
$string['usedeadlines'] = 'Deadlines für Phasen nutzen';
$string['useridinvalid'] = 'Nutzer-ID ungültig';
