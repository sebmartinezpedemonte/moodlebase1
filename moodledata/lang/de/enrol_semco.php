...
/**
 * Strings for component 'enrol_semco', language 'de', version '4.1'.
 *
 * @package     enrol_semco
 * @category    string
...
$string['installer_addedusertorole'] = 'Die Rolle \'SEMCO Webservice\' wurde dem Nutzer \'SEMCO Webservice\' automatisch zugewiesen.';
...
$string['privacy:metadata:enrol_semco:SEMCO'] = 'SEMCO ist ein Seminarverwaltungssystem, das an Moodle angebunden ist,
 um Kurseinschreibungen zu verwalten.';
$string['privacy:metadata:enrol_semco:SEMCO:course_completions'] = 'Kursabschlussdaten einschließlich dem Abschlussdatum, Bewertungen und Abschlussinformationen werden zwischen SEMCO und Moodle geteilt. Die Daten fließen von Moodle nach SEMCO.';
$string['privacy:metadata:enrol_semco:SEMCO:course_enrolments'] = 'Kurseinschreibungsdaten wie Kursmitgliedschaften und Einschreibungsdetails werden zwischen SEMCO und Moodle geteilt. Die Daten fließen von SEMCO nach Moodle.';
$string['privacy:metadata:enrol_semco:SEMCO:user_profile'] = 'Nutzerprofildaten wie Nutzername, Vorname, Nachname und E-Mail-Adresse werden zwischen SEMCO und Moodle geteilt. Die Daten fließen von SEMCO nach Moodle.';
...
$string['semco:resetcoursecompletion'] = 'Zurücksetzen des Kursabschlusses für Nutzer/in und Kurs mit der gegebenen SEMCO Einschreibung';
...
$string['settings_coursecompletionlrcintro'] = '<p>Das SEMCO Einschreibeplugin ist in der Lage, den Kursabschluss für Nutzer/innen zurückzusetzen, sobald diese ein weiteres Mal von SEMCO in einen Kurs eingeschrieben werden.<br />Um diesen Reset umzusetzen und zu vermeiden, das Rad neu zu erfinden, hat dieses Plugin eine lose Abhängigkeit zu <a href="https://moodle.org/plugins/local_recompletion">local_recompletion</a> von Dan Marsden.</p>';
$string['settings_coursecompletionlrcnotfound'] = '<p>Bitte installieren Sie local_recompletion mit mindestens der Version 2023111402 falls Sie planen, mehrfache Kurseinschreibungen mit SEMCO zu nutzen und den Kursabschluss dabei zurücksetzen wollen.<br />Falls Sie dies nicht planen, müssen Sie local_recompletion nicht installieren.</p>';
$string['settings_coursecompletionnote'] = '<p>Bitte beachten: SEMCO stößt nur den \'Bei Bedarf\' Prozess zum Zurücksetzen des Kursabschlusses an, welcher vom Plugin <a href="{$a}">Kurswiederholung</a> bereitgestellt wird. Es liegt weiterhin an den jeweiligen Trainer/innen der Kurse, das Zurücksetzen der Kursabschlüsse im Kurs entsprechend ihres individuellen Bedarfs zu konfigurieren und den Kursabschlusstyp auf \'Bei Bedarf\' zu setzen.</p>';
...
$string['updater_2023100902_addcapability'] = 'Das Recht \'enrol/semco:resetcoursecompletion\' wurde während des Plugin-Updates automatisch zur Rolle \'SEMCO Webservice\' hinzugefügt.';
