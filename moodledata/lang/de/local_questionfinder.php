...
/**
 * Strings for component 'local_questionfinder', language 'de', version '4.1'.
 *
...
$string['author'] = 'Importeur/in der Fragen:';
...
$string['pluginname'] = 'Fragensuche';
$string['privacy:metadata'] = 'Das Plugin zur Fragensuche speichert keine personenbezogenen Daten.';
$string['questiontext'] = 'Bezeichnung der Frage (Fragetext)';
$string['searchbydate'] = 'Datumssuche:';
$string['searchbytext'] = 'Suchbegriff:';
$string['searchinquestionbank'] = 'Suchen in der Fragensammlung';
