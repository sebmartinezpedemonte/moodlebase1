...
/**
 * Strings for component 'qtype_drawing', language 'de', version '4.1'.
 *
...
$string['allowstudentimage'] = 'Hochladen eines Hintergrundbildes für Teilnehmer/innen erlauben.';
$string['allowstudentimage_help'] = 'Erlaubt den Teilnehmer/innen das Hochladen eines Hintergrundbilds.';
$string['allowteachertochosemode'] = 'Den Trainer/innen erlauben, den Zeichnungsmodus zu wählen?';
$string['allowteachertochosemode_help'] = 'Wenn diese Option aktiviert ist, dürfen Trainer/innen den Zeichnungsmodus wählen';
$string['annotation'] = 'Annotation';
$string['annotationsaved'] = 'Annotation gespeichert.';
$string['answer'] = 'Antwort: {$a}';
$string['applychanges'] = 'Änderungen anbringen';
$string['are_you_sure_you_want_to_change_the_drawing_radius'] = 'Falls Sie Ihren Zeichnungsbereich jetzt ändern, wird Ihre Lösung gelöscht. Möchten Sie das?';
$string['are_you_sure_you_want_to_erase_the_canvas'] = 'Möchten Sie wirklich ihre Lösung löschen?';
...
$string['defaultcanvasheight'] = 'Standardzeichenfläche (Canvas) Höhe';
$string['defaultcanvasheight_help'] = 'Hier stellen Sie die Standard-Höhe der Zeichenfläche ein';
$string['defaultcanvaswidth'] = 'Standardzeichenfläche (Canvas) Breite';
$string['defaultcanvaswidth_help'] = 'Hier stellen Sie die Standardbreite der Zeichenfläche ein';
...
$string['drawingcomment'] = 'Mit Freihandzeichnen-Fragetyp (ETHz) für Moodle erstellt.';
$string['drawingmode'] = 'Zeichnungsmodus';
$string['drawingmode_help'] = 'Mit dieser Einstellung kann festgelegt werden, ob die Zeichnung mit dem Standardodus oder mit dem erweiterten Modus gemacht werden soll.';
...
$string['enableeraser'] = 'Den Trainer/innen erlauben, den Radiergummi zu wählen?';
$string['enableeraser_help'] = 'Wenn diese Option aktiviert ist, dürfen Trainer/innen den Radiergummi wählen.';
$string['endx'] = 'End X';
$string['endy'] = 'End Y';
...
$string['pluginname_help'] = 'Als Antwort auf eine Frage wird die Antwort in ein vorgegebenes Bild gezeichnet. Es gibt nur eine richtige Antwort.';
...
$string['pluginnamesummary'] = 'Als Antwort auf eine Frage wird die Antwort in ein vorgegebenes Bild gezeichnet. Es gibt nur eine richtige Antwort.';
$string['preserveaspectratio'] = 'Das Bildseitenverhältnis beibehalten';
$string['privacy:metadata'] = 'Das Plugin Freihandzeichnen speichert keine personenbezogenen Daten.';
$string['radgrad'] = 'Radialer Verlauf';
$string['radiusx'] = 'Radius X';
$string['radiusy'] = 'Radius Y';
$string['rectangle'] = 'Rechteck';
$string['recttool'] = 'Rechtecktool';
...
$string['set_radius'] = 'Stiftgröße festlegen (Pixel)';
...
$string['zoomtool'] = 'Vergrößerungstool';
