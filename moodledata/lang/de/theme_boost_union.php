...
$string['choosereadme'] = '<p>Das Design "Boost Union" ist eine Erweiterung für das Design "Boost". "Boost Union" soll das Design einfach konfigurierbar machen, aber andererseits auch hilfreiche Zusatzfunktionen für den täglichen Moodle-Betrieb von Administrator/innen, Trainer/innen und Teilnehmer/innen bereitstellen.</p>
<p> Boost Union wird von Moodle an Hochschulen e.V. entwickelt und in Kooperation mit lern.link GmbH und bdecent GmbH bereitgestellt.</p>';
...
$string['courseindexmodiconenabled'] = 'Aktivitätstypsymbole im Kursindex anzeigen';
...
$string['courseoverviewshowcourseimagessetting_desc'] = 'Mit dieser Einstellung können Sie steuern, ob das Kursbild im Block Kursüberblick angezeigt wird oder nicht. Es ist möglich, eine andere Einstellung für Kartenansicht, Zusammenfassung und Listenansicht zu wählen.';
...
$string['enablefooterbutton_desc'] = 'Mit "Fußbereich" ist der Kreis mit dem Fragezeichen am Ende der Seite gemeint.<br />Beim Klicken wird Nutzer/innen ein Overlay angezeigt. Abhängig von der Website-Konfiguration zeigt Moodle mehrere Links (wie "Hilfe und Dokumentation" oder "Zusammenfassung der Datenaufbewahrung") in diesem Overlay an.<br />Mit dieser Einstellung können Sie steuern, ob die Taste "Fußbereich" unten auf der Seite angezeigt oder verborgen werden soll.';
...
$string['extscssgithubfilepath_example'] = 'Beispiel: Wenn Sie die Datei in Ihrem Github-Konto unter https://github.com/moodle-an-hochschulen/moodle-theme_boost_union-extscsstest/blob/master/extscss.scss sehen können, lautet der Dateipfad <em>/extscss.scss</em>.';
...
$string['extscssgithubrepo_example'] = 'Beispiel: Wenn Sie die Datei in Ihrem Github-Konto unter https://github.com/moodle-an-hochschulen/moodle-theme_boost_union-extscsstest/blob/master/extscss.scss sehen können, lautet das Repository <em>moodle-theme_boost_union-extscsstest</em>.';
...
$string['extscssgithubuser_example'] = 'Beispiel: Wenn Sie die Datei in Ihrem Github-Konto unter https://github.com/moodle-an-hochschulen/moodle-theme_boost_union-extscsstest/blob/master/extscss.scss sehen können, ist die Institution <em>moodle-an-hochschulen</em>.';
...
$string['extscssheading_drop'] = 'Wenn Boost Union die externe SCSS-Datei aus irgendeinem Grund nicht abrufen kann oder der abgerufene externe SCSS-Code ungültig ist, wird die externe SCSS-Datei ignoriert, um Probleme beim Kompilieren von SCSS und beschädigte Frontends zu vermeiden.';
...
$string['footersuppressfeedbacksetting'] = 'Link "Feedback zu dieser Software geben" unterdrücken';
$string['footersuppressfeedbacksetting_desc'] = 'Mit dieser Einstellung können Sie den Link "Feedback zu dieser Software geben" in der Fußzeile unterdrücken. Dieser Link würde andernfalls erscheinen, wenn die Einstellung <a href="{$a->url}">Feedback zu dieser Software</a> aktiviert ist.';
$string['footersuppressiconssetting'] = 'Icons vor den Fußbereich-Links unterdrücken';
$string['footersuppressiconssetting_desc'] = 'Mit dieser Einstellung können Sie die Icons vor den Links in Fußbereich unterdrücken. z.B.  wird der Link "Dokumentation zu dieser Seite" mit einem Buch gezeigt, "Services und Support" mit einem Rettungsring usw.';
...
$string['footersuppressservicessetting'] = 'Link "Services und Support" unterdrücken';
$string['footersuppressservicessetting_desc'] = 'Mit dieser Einstellung können Sie den Link "Services und Support" in der Fußzeile unterdrücken. Andernfalls würde dieser Link Administratoren den <a href="{$a->url}">Services- und Support-Link</a> anzeigen.';
$string['footersuppressstandardfooter'] = 'Fußzeilenausgabe des Plugins \'{$a}\' unterdrücken';
$string['footersuppressstandardfooter_desc'] = 'Mit dieser Einstellung können Sie die Fußzeilenausgabe durch das Plugin "{$a}" vollständig unterdrücken. Plugins (auch wenn sie mit dem Moodle-Kern ausgeliefert werden, aber technisch gesehen immer noch Plugins sind) können der Fußzeile zusätzlichen Inhalt hinzufügen, indem sie eine bestimmte Funktion implementieren. Dieses Plugin hat diese Funktion implementiert und kann unter bestimmten Umständen Inhalte zur Fußzeile hinzufügen.';
...
$string['policyoverviewnavigationsetting_desc'] = 'Standardmäßig zeigt die Richtlinienübersichtsseite (von tool_policy) kein Navigationsmenü und keine Fußzeile an. Mit dieser Einstellung können Sie die primäre Navigation und die Fußzeile auf dieser Seite anzeigen.';
...
$string['showfullnameinusermenussetting'] = 'Vollständigen Namen im Nutzermenü anzeigen';
$string['showfullnameinusermenussetting_desc'] = 'Mit dieser Einstellung können Sie den vollständigen Namen der angemeldeten Nutzer/innen oben im Nutzermenü anzeigen. Dies kann insbesondere in Prüfungssituationen hilfreich sein, wo Nutzer/innen unbedingt mit dem eigenen Konto angemeldet sein müssen. Es kann aber auch für die Nutzer/innen selbst hilfreich sein. Im Gegensatz zum Design Classic, bei dem der vollständige Name in der Navigationsleiste neben dem Avatar angezeigt wird, beansprucht dieser Ansatz hier keinen zusätzlichen Platz in der Navigationsleiste.';
...
$string['shownavbarstarredcourses_config'] = 'Legen Sie markierte Kurse auf der Seite "Meine Kurse" fest';
...
$string['slideranimationsetting'] = 'Animationstyp fü Slider';
...
$string['sliderfrontpagepositionsetting_beforeafter'] = 'Vor dem Inhalt der Startseite (und nach den Werbekacheln)';
$string['sliderfrontpagepositionsetting_beforebefore'] = 'Vor dem Inhalt der Startseite (aber vor den Werbekacheln)';
...
$string['smartmenusmenuitemcardimage'] = 'Bild der Karte';
...
$string['smartmenusmenumoremenubehavior_help'] = '<p>Wählen Sie aus, was passieren soll, wenn zu viele Menüs vorhanden sind, um in die Menüposition zu passen.</p><ul><li>Nichts ändern: Es wird kein bestimmtes Verhalten erzwungen, überschüssige Menüs werden automatisch in das Mehr-Menü verschoben.</li><li>In das Mehr-Menü zwingen: Dieser Modus verschiebt das Menü direkt in das Mehr-Menü, auch wenn außerhalb noch Platz wäre.</li><li>Außerhalb des Mehr-Menüs behalten: Dieser Modus hält das Menü so lange wie möglich außerhalb des Mehr-Menüs.</li></ul>';
