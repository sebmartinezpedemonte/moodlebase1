...
/**
 * Strings for component 'tool_moodlenet', language 'de', version '4.1'.
 *
...
$string['autoenablenotification'] = '<p>Ab Moodle 4.0 ist die <a href="https://moodle.net/">MoodleNet</a>-Integration standardmäßig in den erweiterten Funktionen aktiviert. Nutzer/innen mit dem Recht, Aktivitäten zu erstellen und zu verwalten, können MoodleNet über die Aktivitätsauswahl durchsuchen und MoodleNet-Ressourcen in ihre Kurse importieren.</p><p>Falls gewünscht, kann eine alternative MoodleNet-Instanz in der <a href="{$a->settingslink}">MoodleNet-Einstellungen</a> festgelegt werden.</p>';
...
$string['enablemoodlenet'] = 'MoodleNet integrieren';
...
$string['moodlenetsettings'] = 'MoodleNet-Einstellungen';
