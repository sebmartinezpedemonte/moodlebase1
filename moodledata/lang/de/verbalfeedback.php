...
/**
 * Strings for component 'verbalfeedback', language 'de', version '4.1'.
 *
...
$string['categoryheader'] = 'Kategorietitel';
...
$string['confirmquestiondeletion'] = 'Möchten Sie diese Frage wirklich löschen?';
$string['course'] = 'Kurs';
$string['criteria'] = 'Kriterien';
$string['criterion'] = 'Kriterium';
$string['dataformatinvalid'] = 'Das Dateiformat, das zum Herunterladen dieses Berichts angegeben wurde, ist entweder ungültig oder nicht aktiviert. Wählen Sie bitte ein gültiges Dateiformat.';
$string['decline'] = 'Ablehnen';
$string['declinefeedback'] = 'Feedback ablehnen';
$string['declineheading'] = 'Verbales Feedback für {$a} ablehnen';
$string['declinereason'] = 'Geben Sie bitte einen Grund an, warum Sie dieses Feedback ablehnen.';
...
$string['downloadtemplate'] = 'Vorlage herunterladen';
...
$string['errorcannotadditem'] = 'Das Kriterium des verbalen Feedbacks konnten nicht hinzugefügt werden.';
...
$string['errorcannotupdateitem'] = 'Das Kriterium des verbalen Feedbacks konnte nicht aktualisiert werden.';
...
$string['errornotingroup'] = 'Sie müssen Mitglied einer Gruppe sein, um an dieser verbalen Feedback-Aktivität teilnehmen zu können. Bitte kontaktieren Sie Ihre Trainer/innen.';
...
$string['errorroleconflict'] = 'Die aktuelle Person ist für diese Instanz gleichzeitig Teilnehmer/in und Trainer/in, was nicht erlaubt ist.';
...
$string['finalize'] = 'Bewertung abschließen';
$string['finalresult'] = 'Schlussresultat';
$string['gotoquestionbank'] = 'Zur verbales Feedback-Fragensammlung gehen';
$string['id'] = 'ID';
$string['instancealreadyclosed'] = 'Diese verbale Feedback-Aktivität wurde bereits beendet.';
$string['instancenotready'] = 'Klicken Sie auf die Schaltfläche „Verfügbar machen“, um den Fragebogen nach der Bearbeitung der Kriterien an die Trainer/innen freizugeben.';
...
$string['pickfromquestionbank'] = 'Frage aus der Fragensammlung auswählen';
...
$string['preserveids'] = 'IDs beibehalten?';
...
$string['privacy:metadata:verbalfeedback_submission:remarks'] = 'Der Grund, warum die befragte Person abgelehnt hat, der empfangenden Person ein Feedback zu geben.';
...
$string['removecategories'] = 'Kategorien entfernen';
$string['removecriteria'] = 'Kriterien entfernen';
$string['removeresponses'] = 'Antworten entfernen';
$string['removesubmissions'] = 'Abgaben entfernen';
$string['removesubratings'] = 'Subratings entfernen';
$string['reportimage'] = 'Logo für Bericht';
$string['reportimage_desc'] = 'Das Bild wird im Kopfbereich von heruntergeladenen Berichten zum verbalen Feedback angezeigt.';
...
$string['templatecategoryplural'] = 'Vorlagenkategorien';
$string['templatecriteriaplural'] = 'Vorlagenkiterien';
$string['templateplural'] = 'Vorlagen';
$string['text'] = 'Text';
...
$string['verbalfeedback:can_participate'] = 'Am verbalen Feedback teilnehmen';
$string['verbalfeedback:can_respond'] = 'In einem verbalen Feedback antworten';
...
$string['verbalfeedback:managetemplates'] = 'Vorlagen für verbales Feedback verwalten';
...
$string['verbalfeedbacktemplates'] = 'Verbales Feedback-Borlagen';
$string['verynegative'] = 'Sehr negativ';
$string['verypositive'] = 'Sehr positiv';
$string['viewfeedbackforuser'] = 'Verbales Feedback für Teilnehmer/in anzeigen';
