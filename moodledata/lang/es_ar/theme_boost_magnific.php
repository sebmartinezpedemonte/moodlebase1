...
/**
 * Strings for component 'theme_boost_magnific', language 'es_ar', version '4.1'.
 *
...
$string['logo_color_desc'] = 'Por favor, carga tu LOGO a color si deseas incluirla en la parte superior. Este logo se mostrará a medida que se desplaza la página y el menú se mostrará en un fondo blanco.';
$string['logo_write'] = 'Logo en menú superior al desplazarse';
...
$string['privacy:metadata'] = 'El tema Boost Magnific no almacena ningún dato personal sobre ninguna persona.';
...
$string['theme_boost_magnific_frontpage_home'] = 'Bloques de la Portada';
