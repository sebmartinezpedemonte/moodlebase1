...
/**
 * Strings for component 'theme_adaptable', language 'fr', version '4.1'.
 *
...
$string['buttontexthovercolordesc'] = 'La couleur du texte du bouton change en cas de survol du bouton';
...
$string['categoryheaderbgimagetextcolour'] = 'Catégorie \'{$a->name}\' avec l\'identifiant \'{$a->id}\' de couleur du texte de l\'image d\'arrière-plan';
$string['categoryheaderbgimagetextcolourdesc'] = 'Définir une couleur de texte d\'image d\'arrière plan pour la catégorie de niveau supérieur \'{$a->name}\' avec l\'identifiant \'{$a->id}\' et ses sous-catégories \'{$a->children}\' dans l\'en-tête.';
$string['categoryheaderbgimagetextcolourdescchildren'] = 'Définir une couleur de texte d\'image d\'arrière-plan pour la catégorie de niveau supérieur \'{$a->name}\' avec l\'identifiant \'{$a->id}\' et ses sous-catégories \'{$a->children}\' dans l\'en-tête.';
...
$string['coursepageheaderhidetitledesc'] = 'Masquer le titre de l’en-tête, le logo et la barre de recherche sur les pages du cours. Utiliser le paramètre de hauteur d\'en-tête de page pour afficher un en-tête plus petit sur les pages liées au cours.';
...
$string['customcssjssettingsheading'] = 'Appliquez vos propres modifications';
$string['customcsssettings'] = 'CSS personnalisé';
...
$string['privacy:request:preference:themeadaptablealertkey'] = 'La préférence utilisateur "{$a->name}" pour l\'ID d\'alerte "{$a->alertid}" a la valeur "{$a->value}" pour l\'alerte donnée, "undismissable" ou toute autre "alertkey". représentant que l’alerte existait pour l’utilisateur.';
