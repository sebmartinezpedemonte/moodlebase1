...
/**
 * Strings for component 'auth_db', language 'he', version '4.1'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbextrafields'] = 'שדות אלו הינם שדות־רשות. אתה יכול לבחור למלא מראש חלק משדות המשתמש של Moodle באמצעות נתונים מ<b>שדות בסיס נתונים חיצוני</b> שתגדיר כאן. <br />אם תשאיר שדה זה ריק, אז יופעלו ברירות מחדל .<br />בכל מקרה, המשתמש יוכל לשנות את כל השדות הללו לאחר התחברות.';
