...
/**
 * Strings for component 'auth_ldap', language 'he', version '4.1'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_attrcreators'] = 'רשימת קבוצות או אזורי־תוכן אשר חבריהם רשאים ליצור תכונות. הפרד קבוצות רבות עם הסימן \';\'. בדר"כ יראה למשל כך \'cn=teachers,ou=staff,o=myorg\'';
$string['auth_ldap_attrcreators_key'] = 'יוצרי תכונות';
$string['auth_ldap_auth_user_create_key'] = 'יצירת משתמשים באופן חיצוני';
...
$string['auth_ldap_create_context'] = 'אם תאפשר יצירת משתמשים עם אימות דואר אלקטרוני,  פרט את ההקשר בו ייווצרו המשתמשים. הקשר זה צריך להיות שונה ממשתמשים אחרים כדי למנוע בעיות אבטחה. אתה לא צריך להוסיף את הרמה (context) זה לldap_context-variable, Moodle ייחפש משתמשים מהרמה (context) זה באופן אוטומטי.';
$string['auth_ldap_create_context_key'] = 'הקשרים עבור משתמשים חדשים';
$string['auth_ldap_create_error'] = 'שגיאה ביצירת משתמש ב-LDAP';
$string['auth_ldap_expiration_desc'] = 'יש לבחור ב\'לא\' כדי למנוע בדיקת סיסמאות שפג תוקפן או כדי למנוע מה-LDAP לקרוא את זמן תפוגת התפוקה ישירות מה-LDAP';
...
$string['auth_ldap_expireattr_desc'] = 'לבחירתכם: עדכון מאפיין LDAP השומר את זמן פגות־תוקף הסיסמה.';
...
$string['auth_ldap_gracelogins_desc'] = 'אפשרו תמיכת gracelogin ב-LDAP. לאחר שפג תוקפה של הסיסמה, המשתמש עדיין יכול להתחבר עד שהמונה ב-gracelogin מתאפס.  אפשרו ההגדרה הזו על מנת להציג הודעה של gracelogin שפג תוקף הסיסמה.';
$string['auth_ldap_gracelogins_key'] = 'התחברויות דרך Grace';
$string['auth_ldap_groupecreators'] = 'רשימת קבוצות או אזורי־תוכן אשר חבריהם רשאים ליצור קבוצות חדשים. הפרד קבוצות מרובות באמצעות \';\'. בדרך כלל משהו כגון \'cn=teachers,ou=staff,o=myorg\'';
...
$string['auth_ldap_ldap_encoding'] = 'יש לציין את הקידוד בו משתמש שרת ה-LDAP. רוב הסיכויים ש-utf-8, MS AD v2 משתמש בקידוד בררת־מחדל כמו cp1252, cp1250 וכו\'.';
...
$string['auth_ldap_no_mbstring'] = 'יש להתקין PHP mbstring בכדי ליצור משתמשים ב-Active Directory.';
...
$string['auth_ldap_objectclass'] = 'לבחירתכם: עוקף את objectClass  שמשמש לתת שם לערוך חיפוש משתמשים ב-LDAP_user_type. לרוב, אין צורך לשנות את הגדרה זו.';
...
$string['auth_ldap_passwdexpire_settings'] = 'הגדרות פגות־תוקף סיסמאת LDPA.';
...
$string['auth_ldap_search_sub'] = 'יש להזין ערך שאינו 0 כאשר מעוניינים לחפש משתמשים מתתי־הקשרים.';
...
$string['auth_ldap_user_type'] = 'ביחרו כיצד LDAP שומר משתמשים. בנוסף, הגדרה זו קובעת כיצד פגה ההתחברות, grace logins ויצירת משתמשים יעבדו.';
...
$string['auth_ldap_version_key'] = 'גרסה';
...
$string['auth_ldapextrafields'] = 'שדות אלו הם שדות־רשות. אתה יכול לבחור למלא מראש שדות משתמש שתפרט פה עם מידע מה<b>LDAP שדות</b>. <br /> אם תשאיר שדות אלו ריקים אז דבר לא יעבור מ-LDAP ובמקומם ישתמשו בברירות המחדל של Moodle .<br />
</p><p>
...
$string['auth_ntlmsso_ie_fastpath_attempt'] = 'נסה NTLM בכל הדפדפנים';
$string['auth_ntlmsso_ie_fastpath_key'] = 'נתיב מהיר MS IE?';
$string['auth_ntlmsso_ie_fastpath_yesform'] = 'כן, כל הדפדפנים משתמשים בטופס התחברות רגיל';
$string['auth_ntlmsso_remoteuserformat_key'] = 'תצורת שם משתמש במערכת המרוחקת';
...
$string['needbcmath'] = 'יש צורך בהרחבת BCMath לשימוש בחיבורי grace  עם Active Directory';
$string['needmbstring'] = 'יש צורך בהרחבת mbstring לצורך שינוי סיסמאות ב Active Directory';
...
$string['pagesize_key'] = 'גודל העמוד';
$string['pluginname'] = 'שרת LDAP';
...
$string['start_tls_key'] = 'השתמש ב- TLS';
