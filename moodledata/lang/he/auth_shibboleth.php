...
/**
 * Strings for component 'auth_shibboleth', language 'he', version '4.1'.
 *
...
Moodle יציג בתפריט הנפתח בעמוד התחברות חלופי זה  שהמשתמש הצטרך לבחור את זהות הספק שלו.';
$string['auth_shib_logout_return_url'] = 'כתובת יציאת URL חלופית לחזרה';
...
$string['auth_shibboleth_errormsg'] = 'יש לבחור את הארגון בו את/ה חבר/ה';
...
$string['auth_shibboleth_select_organization'] = 'לאימות בעזרת מנגנון "שיבולת" יש לבחור את הארגון אליו את/ה שייך מתפריט:';
...
$string['pluginname'] = 'שרת Shibboleth';
$string['shib_no_attributes_error'] = 'נראה כי אתה מאומת באמצעות "שיבולת", אבל המערכת לא קיבלה כל מאפייני המשתמש. יש לוודא שמספק הזהות שלך משחרר את התכונות הדרושות ({$a}) למספק השרות שמוודל מריץ או שידע את מנהל הרשת של שרת זה.';
