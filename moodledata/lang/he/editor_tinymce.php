...
/**
 * Strings for component 'editor_tinymce', language 'he', version '4.1'.
 *
...
$string['advanced:charmap_desc'] = 'הוספת תו מיוחד';
...
$string['advanced_dlg:about_version'] = 'גרסה';
...
$string['advanced_dlg:charmap_title'] = 'בחירת תו מיוחד';
...
$string['advanced_dlg:image_dimensions'] = 'ממדים';
...
$string['advanced_dlg:link_is_email'] = 'כתובת ה-URL שהוכנסה היא ככל הנראה כתובת דואל האם ברצונך להוסיף את הקידומת MAILTO הנדרשת?';
...
$string['advanced_dlg:link_target_blank'] = 'פתיחת קישור בחלון חדש';
$string['advanced_dlg:link_target_same'] = 'פתיחת קישור באותו חלון';
...
$string['advimage_dlg:missing_alt'] = 'להמשיך מבלי להוסיף תיאור לתמונה? ללא תיאור, יתכן שלא תיהיה גישה  לתמונה עבור משתמשים בעלי מוגבלויות , לאלו המשתמשים בדפדפן עם טקסט בלבד  או למי שכיבה הצגת תמונות בדפדפן שלו.';
...
$string['advlink_dlg:is_email'] = 'כתובת ה-URL שהוכנסה היא ככל הנראה כתובת דואל האם ברצונך להוסיף את הקידומת MAILTO הנדרשת?';
...
$string['autosave:warning_message'] = 'שיחזור התוכן השמור, יאבד את כל התוכן אשר כרגע נמצא בעורך התוכן המעוצב.

האם לשחזר את התוכן השמור?';
...
האם ברצונך לקבל מידע נוסף על הנושא?';
$string['common:clipboard_no_support'] = 'אפשרויות "העתקה והדבקה" של מידע לא נתמכות על ידי הדפדפן שלך. יש להשתמש בקיצורי המקלדת, כחלופה';
$string['common:close'] = 'סגירה';
$string['common:edit_confirm'] = 'האם להשתמש בעורך תוכן מעוצב מתקדם?';
...
$string['insertdatetime:months_long'] = 'ינואר,פברואר,מרץ,אפריל,מאי,יוני,יולי,אוגוסט,ספטמבר,אוקטובר,נובמבר,דצמבר';
$string['insertdatetime:months_short'] = 'ינו,פבר,מרץ,אפר,מאי,יונ,יול,אוג,ספט,אוק,נוב,דצמ';
...
$string['media_dlg:constrain_proportions'] = 'שמירה על יחסיות';
...
$string['media_dlg:loop'] = 'תצוגה מחזורית';
...
$string['media_dlg:nojava'] = 'ללא Java';
...
$string['media_dlg:preload_metadata'] = 'טעינה מוקדמת של המידה־הנלווה לסרט';
...
$string['media_dlg:qt_stream_warn'] = 'משאבי זרימת סרטים של RTSP אמורים להתווסף שדה ה-QT Src תחת לשונית המתקדם.
כדאי גם להוסיף גרסה שאינה בזרימת הסרטים לשדה ה-QT Src.';
...
$string['pagebreak:desc'] = 'הוספת מעבר דף (page brake)  עבור הדפסה';
$string['paste:paste_text_desc'] = 'הדבקה כטקסט בלבד';
$string['paste:paste_word_desc'] = 'הדבקה מ-WORD';
$string['paste:plaintext_mode'] = 'מנגנון הדבקה נמצא כעת במצב מלל פשוט.  יש להקליק כדי לחזור למצב הדבקה רגיל.  לאחר שהדבקתם מלל כלשהו תחזרו למצב הדבקה רגיל.';
...
$string['pluginname'] = 'עורך תוכן מעוצב TinyMCE';
...
$string['searchreplace_dlg:findnext'] = 'חיפוש הבא';
...
$string['style:desc'] = 'עריכת הגדרות CSS';
$string['style_dlg:apply'] = 'החל';
$string['style_dlg:background'] = 'רקע';
$string['style_dlg:background_attachment'] = 'קובץ מצורף';
...
$string['style_dlg:background_repeat'] = 'חזרה';
...
$string['style_dlg:title'] = 'עריכת עיצוב CSS';
...
$string['table:desc'] = 'הכנסה/עריכת טבלה חדשה';
...
$string['table_dlg:missing_scope'] = 'האם הינך בטוח כי ברצונך ללא ציון מקום עבור תא כותרת עליונה של טבלה זו.
ללא דבר זה, יהיה  קצת קשה למשתמשים עם מוגבלויות  להבין את ההקשר או הנתונים של הטבלה אשר יוצגו .';
...
$string['table_dlg:rowgroup'] = 'קבוצת שורות';
$string['table_dlg:rows'] = 'שורות';
$string['table_dlg:rowtype'] = 'סוג השורה';
...
$string['table_dlg:th'] = 'כותרת עליונה';
...
$string['xhtmlxtras:acronym_desc'] = 'ראשי תיבות';
...
$string['xhtmlxtras_dlg:fieldset_attrib_tab'] = '';
$string['xhtmlxtras_dlg:fieldset_events_tab'] = '';
...
$string['xhtmlxtras_dlg:remove'] = 'הסרה';
$string['xhtmlxtras_dlg:title_abbr_element'] = 'רכיב ראשי־תיבות';
$string['xhtmlxtras_dlg:title_acronym_element'] = 'רכיב ראשי תיבות';
$string['xhtmlxtras_dlg:title_cite_element'] = 'ציטוט';
$string['xhtmlxtras_dlg:title_del_element'] = 'מחיקה';
$string['xhtmlxtras_dlg:title_ins_element'] = 'הכנסה';
