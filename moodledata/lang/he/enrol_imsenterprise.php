...
/**
 * Strings for component 'enrol_imsenterprise', language 'he', version '4.1'.
 *
...
$string['allowunenrol_desc'] = 'כאשר פעיל, שיוכים לתפקידים בקורס יוסרו, כאשר מידע ארגוני (Enterprise) מוגדר.';
...
$string['createnewusers'] = 'יצירת חשבונות משתמשים עבור משתמשים שעדיין לא נרשמו למוודל.';
...
<p>סיסמאות לא ניתנים ליבוא מהתקן ה-IMS Enterprise. אנו ממליצים להשתמש במערכת התקני האימותים של Moodle בכדי לאמת משתמשים.</p>
</div>';
...
$string['doitnow'] = 'ביצוע יבוא IMS Enterprise כעת';
$string['emptyattribute'] = 'השאר ריק';
...
$string['pluginname_desc'] = 'שיטה זו תבדוק באופן תמידי תהליך תבניתי של קובץ טקסט במיקום שתגדיר לו. הקובץ מוכרח לאפשר מפרטים של IMS Enterprise המכילים אישיות, קבוצה ומרכיבי חברות של XML.';
$string['processphoto'] = 'הוספת נתוניי תמונה לפרופיל המשתמש';
...
<p>במצבים מסויימים יכול להיות שתרצו לקצץ קודים של קורסים לאורך מסויים, לפני שאתם מעבדים אותם. אם זהו המצב, הכניסו את מספר התווים בקופסא זו. אחרת, השאירו את שדה הזה <strong>ריקה</strong>, כך שלא יתרחש כל קיצוץ.
</p>';
$string['updatecourses'] = 'עדכון קורס';
$string['usecapitafix'] = 'יש לסמן משבצת זו אם אתה משתמש ב-"Capita" ( תסדיר ה-XML שגוי מעט)';
