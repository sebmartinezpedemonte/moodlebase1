...
/**
 * Strings for component 'enrol_ldap', language 'he', version '4.1'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['bind_dn_key'] = 'קישור לשם תואר המשתמש';
...
$string['couldnotfinduser'] = 'לא ניתן למצוא את משתמש \'{$a}\', ממשיך הלאה';
$string['course_fullname'] = 'לבחירתכם: שדה LDAP ממנו ניתן להשיג את השם המלא.';
$string['course_fullname_key'] = 'שם מלא';
$string['course_fullname_updateonsync'] = 'עדכן שם מלא בעת ריצת הסנכרון';
$string['course_fullname_updateonsync_key'] = 'עדכן שם מלא';
...
$string['course_shortname_updateonsync'] = 'עדכן שם קצר בעת ריצת הסנכרון';
$string['course_shortname_updateonsync_key'] = 'עדכן שם קצר';
$string['course_summary'] = 'ניתן לבחירה: שדה LDAP ממנו ניתן להשיג את הסיכום.';
$string['course_summary_key'] = 'Summary';
$string['course_summary_updateonsync'] = 'עדכן תקציר בעת ריצת הסנכרון';
$string['course_summary_updateonsync_key'] = 'עדכן תקציר';
$string['creatingcourse'] = 'יוצר קורס \'{$a}\'...';
$string['editlock'] = 'נעילת ערך';
...
$string['nested_groups_settings'] = 'הגדרות קבוצות בתוך קבוצות';
$string['objectclass'] = 'objectClass בו משתמשים כדי לחפש בקורסים. לרוב:
\'posixGroup\'';
$string['pluginname'] = 'רישום משרת LDAP';
