...
/**
 * Strings for component 'enrol_mnet', language 'he', version '4.1'.
 *
 * @package     enrol_mnet
 * @category    string
...
אם נשאיר את שדה זה ריק, ערך בררת־מחדל של מופע זה (מערכת מוודל זו) יבוא לידי שימוש אשר יכיל את שם מחשב המארח המרוחק ואת התפקיד שמוקצה למשתמשים שלו.';
...
$string['pluginname'] = 'רישום משרת MNET מרוחק';
$string['pluginname_desc'] = 'אפשר לשרתי MNET מרוחקים לרשום את המשתמשים שלהם לקורסים שלנו (או להפך)';
