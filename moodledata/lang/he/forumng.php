...
/**
 * Strings for component 'forumng', language 'he', version '4.1'.
 *
 * @package     forumng
 * @category    string
...
$string['alt_discussion_moderator'] = 'לדיון זה יש מנהל/ת';
...
$string['anonymousmoderator'] = 'מנהל/ת דיון אנונימי/ת';
...
$string['asmoderator'] = 'פרסום כ?';
$string['asmoderator_post'] = 'פרסום רגיל';
$string['asmoderator_self'] = 'הזדהה כמנהל/ת';
$string['atom'] = 'Atom';
...
$string['automaticallylock'] = 'נעילה אוטומטית';
...
$string['confirmdeletediscuss'] = 'מחיקת דיון';
...
$string['copytoself'] = 'שליחת העתק לעצמי';
...
$string['deletedforumpost'] = 'התגובה שלכם נמחקה';
...
$string['discussiontags'] = 'תגיות הדיון';
...
$string['editedforumpost'] = 'התגובה שלך עברה עריכה';
...
$string['emailauthor'] = 'דואל העורך';
$string['emailerror'] = 'התרחשה תקלה בעת שליחת הדואל';
...
$string['enableratings'] = 'מנגנון הדרוג פעיל';
$string['enabletagging'] = 'הפעלת מנגנון תיוג דיונים';
...
$string['error_ratingrequired'] = 'יש להפעיל את מנגנון דרוג פרסומים ותגובות,  כאשר מעוניינים לבסס את הציון הכולל של התמשתמש בפעילות על שיטת חישוב כלל הדרוגים אשר ניתנו על פרסומי ותגובות המשתמש.';
...
$string['event:discussioncreated'] = 'הוספת דיון';
$string['event:discussiondeleted'] = 'מחיקת דיון';
$string['event:discussionlocked'] = 'נעילת דיון';
$string['event:discussionmerged'] = 'איחוד דיונים';
$string['event:discussionpermdeleted'] = 'מחיקה דיון באופן מוחלט';
$string['event:discussionundeleted'] = 'שיחזור דיון';
$string['event:discussionunlocked'] = 'ביטול נעילת דיון';
$string['event:discussionviewed'] = 'תצוגת דיון';
$string['event:mailsent'] = 'הדואל נשלח באופן תקין';
$string['event:postcreated'] = 'הוספת תגובה';
$string['event:postdeleted'] = 'מחיקת תגובה';
$string['event:postreported'] = 'דיווח אודות התגובה';
$string['event:postsplit'] = 'פיצול תגובה';
$string['event:postundeleted'] = 'שיחזור תגובה';
$string['event:postupdated'] = 'עריכת תגובה';
$string['event:subscriptioncreated'] = 'יצירת מנוי לדיון';
$string['event:subscriptiondeleted'] = 'הסרת מנוי מדיון';
...
$string['filterdiscussions'] = 'תצוגת דיונים בעלי תגית';
$string['flaggeddiscussions'] = 'דיונים מסומנים';
$string['flaggeddiscussionslink'] = '{$a} דיונים מסומנים';
...
$string['forumng:addinstance'] = 'הוספת פעילות פורום מתקדם';
...
$string['forumng:grade'] = 'דרוג פרסומים';
...
$string['forumngdiscusstagfilter'] = 'צפיה בדיונים לפי תג';
...
$string['includepost'] = 'הוספת התגובה';
...
$string['managepostalerts'] = 'ניהול דוח התראות אודות תגובות';
$string['markdiscussionread'] = 'סמנו את כל הדיונים בפרסום זה כ: "נצפו"';
$string['markpostread'] = 'סימון תגובה כ"נקראה"';
$string['message'] = 'הודעה';
$string['moderator'] = 'מנהל/ת';
...
$string['ratingfrom'] = 'דרוג פרסומים זמין מ:';
$string['ratings'] = 'דרוג פרסומים (דיונים ותגובות)';
$string['ratingthreshold'] = 'נדרש לבצע דרוג';
$string['ratingthreshold_help'] = 'במידה ותגדירו 3 עבור אפשרות זו, אזי דירוג הפרסום לא יוצג עד שלפחות 3 משתמשים דרגו אותו. מהלך זה מאפשר צמצום השפעת דרוג בודד על הממוצע הכללי.';
$string['ratingtime'] = 'הגבלת דרוגים לפרסומים בעלי תאריכים בטווח זה:';
$string['ratinguntil'] = 'דרוג פרסומים זמין עד:';
$string['readafterdays'] = 'צפו אחר מספר ימים';
$string['readdata'] = 'צפו בנתונים';
$string['remove'] = 'הסרה';
$string['removefiltering'] = 'צפיה בדיונים המתוייגים ב:{$a}';
...
$string['removeolddiscussionsafter'] = 'הסרת דיונים ישנים לאחר:';
...
$string['selectdiscintro'] = 'יש להקליק על "משבצת-הסימון" לצד כל דיון אותו אתם מעוניינים לבחור.  לסיום, יש לגלול לתחתית רשימת הדיונים ולהקליק על הכפתור "אישור הבחירה"';
$string['selectedposts'] = 'פרסומים נבחרים (מסומנים)';
$string['selectintro'] = 'יש להקליק על "משבצת-הסימון" לצד כל פרסום אותו אתם מעוניינים לבחור.  לסיום, יש לגלול לתחתית רשימת הפרסומים ולהקליק על הכפתור "אישור הבחירה"';
$string['selectlabel'] = 'בחרו פרסום {$a}';
$string['selectorall'] = 'האם אתם מעוניינים לכלול את הדיון כולו, או  את הפרסומים הנבחרים בלבד?';
$string['selectoralldisc'] = 'כל הדיונים המוצגים';
$string['selectordiscall'] = 'הם לכלול את כל הדיונים אשר מוצגים בעמוד, או רק את הדיונים המסומנים?';
$string['selectorselectdisc'] = 'בחירת דיון';
$string['selectorselecteddisc'] = 'בחירת דיונים';
$string['sendanddelete'] = 'שליחה ומחיקה';
$string['set'] = 'עריכה';
$string['setflag'] = 'סמנו הודעה/פרסום זה, לשימוש עתידי.';
$string['setforumtags'] = 'הגדרת תגיות לפורום';
$string['setimportant'] = 'סמנו הודעה זו כ\'חשובה';
$string['shared'] = 'שיתוף קבוצת־דיון זו';
$string['shared_help'] = 'כאשר בוחרים לשתף קבוצת דיון זו, יש לסמן קבוצת־דיון זו כ"שיתופית" ובנוסף לזהות אותה בשם ייחודי תחת הגדרות "קוד זיהוי יחודי" המופיעות תחת "הגדרות רכיב כלליות".

כעת, תוכלו ליצור קבוצות דיון חדשות המקושרות לקבוצת דיון זו על בסיס "קוד הזיהוי היחודי" אשר צויין עבור קבוצת־דיון זו.

כאשר מקשרים קבוצת־דיון חדשה לקבוצת־דיון זו יש להשתמש בהגדרה "קישור לקבוצת־דיון בעלת קוד הזיהוי", בו תזינו את "קוד הזיהוי היחודי" של קבוצת־דיון זו.';
...
$string['show_all'] = 'תצוגת הכל';
$string['showidnumber'] = 'תצוגת מספרי זיהוי';
$string['showusername'] = 'תצוגת שמות משתמשים';
$string['skipstickydiscussions'] = 'דלגו על דיונים "דביקים"';
...
$string['tagging'] = 'תיוג';
$string['teacher_grades_students'] = 'מתן ציון כולל על ידי המורה';
$string['text_asc'] = 'א-ת';
...
$string['useshared_help'] = 'אם ברצונכם ליצור קישור של קבוצת־דיון זו לקבוצת־דיון משותפת קיימת, בחרו באפשרות זו והזינו את מספר הזיהוי של קבוצת־הדיון המקורית.

למעשה, פעולה זו אינה יוצרת קבוצת־דיון חדשה, אלא יוצרת קישור לקבוצת־דיון  קיימת. למעט היכולות של זמינות ואפשרויות מעקב ההתקדמות למידה (המתבצעת ידנית בלבד).';
