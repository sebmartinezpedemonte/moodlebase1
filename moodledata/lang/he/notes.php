...
/**
 * Strings for component 'notes', language 'he', version '4.1'.
 *
 * @package     notes
 * @category    string
...
$string['addnewnoteselect'] = 'בחירת משתמשים אליהם תרצה לכתוב הערות מורה';
