...
/**
 * Strings for component 'local_qeupgradehelper', language 'it', version '4.1'.
 *
...
$string['areyousureresetmessage'] = 'Il quiz \'{$a->name}\' nel corso {$a->shortname} contiene {$a->totalattempts} tentativi, dei quali {$a->convertedattempts} sono stati aggiornati dal sistema precedente. Di questi, {$a->resettableattempts} possono essere resettati per essere convertiti di nuovo in seguito. Vuoi procedere?';
$string['attemptstoconvert'] = 'Tentativi da aggiornare';
$string['backtoindex'] = 'Torna alla pagina principale';
$string['conversioncomplete'] = 'Aggiornamento completato';
$string['convertattempts'] = 'Aggiorna tentativi';
$string['convertedattempts'] = 'Tentativi aggioranti';
$string['convertquiz'] = 'Aggiornamento tentativi...';
...
$string['cronprocesingtime'] = 'Tempo di elaborazione per ciascuna esecuzione via corn';
...
$string['cronstarthour'] = 'Ora di inzio';
...
$string['invalidquizid'] = 'Id quiz non valido. Il quiz non esiste oppure non contiene tentativi da aggiornare';
...
$string['listupgraded'] = 'Elenca i quiz già aggiornati che è possibile resetttare';
...
$string['listupgradedintro'] = 'Questi sono tutti i quiz i cui tentativi sono stati aggiornati e dove i dati precedenti sono ancora presenti ed è quindi possibile resettarli  ed effettuare di nuovo l\'aggiornamento.';
...
$string['resetcomplete'] = 'Il reset è stato completato';
$string['resetquiz'] = 'Reset dei tentativi...';
...
$string['veryoldattemtps'] = 'Il sito ha {$a} tentativi di quiz che non sono stati aggiornati completamente durante la migrazione da Moodle 1.4 a Moodle 1.5. Questi tentativi devono essere gestiti prima di eseguire l\'aggiornamento generale. E\' importante valutare il tempo necessario per questo aggiornamento.';
