...
/**
 * Strings for component 'theme_boost_magnific', language 'it', version '4.1'.
 *
...
$string['content_pagefonts'] = 'Fonti Extra di Google';
$string['content_pagefonts_desc'] = 'Aggiungi qui il link @import da Google per le fonti extra.<br>Puoi inserire più importazioni.<br><a href="https://fonts.google.com/selection/embed" target="google">Codice di incorporamento</a><br><img src="{$a}" style="max-width: 100%;width: 420px;">';
...
$string['frontpage_about_logo_desc'] = 'Se impostato, questo logo verrà utilizzato qui invece del logo Principale.<br>
Se vuoto, verrà utilizzato il logo Principale!';
...
$string['settings_icons_block'] = 'Icona {$a}';
...
$string['settings_icons_default_download'] = 'Scarica';
$string['settings_icons_default_game'] = 'Gioco';
$string['settings_icons_default_money'] = 'Finanziario';
$string['settings_icons_default_slide'] = 'Diapositive';
$string['settings_icons_default_support'] = 'Supporto';
$string['settings_icons_default_video_file'] = 'Video';
$string['settings_icons_heading'] = 'Icone';
$string['settings_icons_image'] = 'Immagine icona';
$string['settings_icons_image_desc'] = 'Carica l\'immagine SVG o PNG dell\'icona desiderata da sostituire nel corso.<br>Dimensioni consigliate: 24px. Se PNG, ricorda la trasparenza.';
$string['settings_icons_module_disable'] = 'La selezione dell\'icona personalizzata è disabilitata. Attiva in {$a}';
$string['settings_icons_name'] = 'Nome icona';
$string['settings_icons_name_desc'] = 'Aggiungi il nome dell\'icona per una selezione facile nel modulo';
$string['settings_icons_none'] = 'Nessuna icona personalizzata';
$string['settings_icons_num'] = 'Numero di icone';
$string['settings_icons_num_desc'] = 'Quantità di icone personalizzate che desideri aggiungere';
$string['settings_icons_select_icon'] = 'Seleziona l\'icona personalizzata. Modifica in {$a}';
...
$string['settings_top_heading'] = 'In alto';
...
$string['theme_color-color_names'] = 'Colore dei Nomi';
$string['theme_color-color_names_desc'] = 'Colore usato per evidenziare nomi o identificatori, fornendo chiarezza ed enfasi su informazioni testuali specifiche.';
...
$string['theme_color-color_titles'] = 'Colore dei Titoli';
$string['theme_color-color_titles_desc'] = 'Il colore usato per i titoli, fornendo evidenza e struttura visiva al contenuto della pagina.';
$string['theme_color_blue'] = 'Blu';
...
$string['theme_color_green_d'] = 'Verde Scuro';
$string['theme_color_heading'] = 'Selezione del Colore dell\'Ambiente';
$string['theme_color_red_d'] = 'Rosso';
$string['theme_color_violet'] = 'Viola';
