...
/**
 * Strings for component 'theme_boost_union', language 'it', version '4.1'.
 *
...
$string['flavourscustomcss'] = 'CSS personalizzato';
$string['flavourscustomcss_help'] = 'Con questa impostazione, è possibile scrivere CSS personalizzato per il flavour. Verrà aggiunto allo stack di codice CSS che viene inviato al browser non appena il flavour viene applicato. Si noti che, allo stato attuale dell\'implementazione, questa impostazione consente solo l\'uso di CSS personalizzati, non di SCSS.';
