...
/**
 * Strings for component 'tool_moodlenet', language 'it', version '4.1'.
 *
...
$string['enablemoodlenet'] = 'Abilita integrazione MoodleNet';
...
$string['moodlenetsettings'] = 'Impostazioni MoodleNet';
