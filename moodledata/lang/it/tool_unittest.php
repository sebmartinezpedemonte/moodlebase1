...
/**
 * Strings for component 'tool_unittest', language 'it', version '4.1'.
 *
...
$string['tablesnotsetup'] = 'Le tabelle per lo unit test non sono ancora state create. Le vuoi creare adesso?';
