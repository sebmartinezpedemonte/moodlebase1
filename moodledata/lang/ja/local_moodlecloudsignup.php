...
/**
 * Strings for component 'local_moodlecloudsignup', language 'ja', version '4.1'.
 *
...
$string['homepage:body.intro'] = 'Moodleを作っている人によるフリーのMoodleホスティングです。';
...
$string['login:security.login.username'] = 'MoodleCloud名';
...
$string['portal:historical.fetchfailure.title'] = 'まさか!';
$string['portal:list.body.lead'] = '&nbsp;';
$string['portal:list.body.title'] = 'MoodleCloudポータル';
...
$string['portal:siteinfo.panels.info.location'] = 'ロケーション';
...
$string['portal:statistics.fetchfailure.title'] = 'まさか!';
...
$string['portal:view.danger.modal.buttons.cancel'] = 'すべて大きな誤解です!';
$string['portal:view.danger.modal.buttons.continue'] = '本当に本当に私のMoodleCloudサイトを削除する';
$string['portal:view.danger.modal.lead'] = '以下を承認することにより、あなたがすべてのコンテンツを精査して、あなたのサイトが私たちのシステムから永久に削除されてしまうことを承認したことになります。';
...
$string['signup:authcode.body.title'] = 'あなたの電話番号を確認してください。';
$string['signup:authcode.form.fields.authcode'] = '認証コード';
$string['signup:authcode.form.fields.continue'] = '続ける';
$string['signup:authcode.form.placeholders.authcode'] = '123456';
$string['signup:errors.blacklistinline'] = '申し訳ございません、そのサイトは利用できません。';
$string['signup:errors.invalidinline'] = '申し訳ございません、サイト名は半角英数字およびハイフンで構成された3～53文字の長さにする必要があります。';
$string['signup:errors.maxsites'] = 'すでに当該電話番号によるユーザアカウントが存在します。ユーザは単一のMoodleCloudインスタンスのみ作成することができます。';
...
$string['signup:page.title'] = 'MoodleCloud: フリーMoodleホスティングにサインアップする';
$string['signup:password.body.lead'] = '&nbsp;';
$string['signup:password.body.title'] = '最後にあなたのパスワードを設定します!';
$string['signup:password.form.fields.password'] = '新しいパスワード';
$string['signup:password.form.fields.password_confirmation'] = '新しいパスワードをもう一度';
$string['signup:password.form.fields.save'] = 'パスワードを保存する';
$string['signup:password.form.placeholders.password'] = '&nbsp;';
$string['signup:password.form.placeholders.password_confirmation'] = '&nbsp;';
$string['signup:personal.body.lead'] = '私たちはあなたが誰であるか知る必要があります。私たちの利用規約に同意したことを確認してください。';
$string['signup:personal.body.title'] = 'あなたのサイトの準備ができました!';
$string['signup:personal.form.fields.continue'] = '続ける';
...
$string['signup:personal.form.fields.tandc'] = '続けるにはあなたは最初に私たちの利用規約に同意する必要があります。';
...
$string['signup:reserve.body.lead'] = 'あなたの固有のサイト名を入力して、ロケーションを選択してください (これはあなたのサイトが提供される場所です。そのため、あなたとあなたの生徒・学生に近い場所の選択をお勧めします)。';
$string['signup:reserve.body.title'] = 'あなたのMoodleCloudサイト利用開始まで、ほんの少しクリックするだけ!';
$string['signup:reserve.form.fields.continue'] = '私のサイトを取得する';
$string['signup:reserve.form.fields.region'] = 'ホスティングロケーション';
$string['signup:reserve.form.fields.subdomain'] = 'サイト名';
...
$string['status:tooltip.pendingIdentityConfirmation'] = 'このサイトは予約されています。確認SMSが送信されました。';
...
$string['validators:signup.email.format'] = '有効なメールアドレスを入力してください。';
$string['validators:signup.email.mustexist'] = 'あなたのメールアドレスを入力してください。';
$string['validators:signup.status.password_mismatch'] = 'あなたが入力したパスワードが合致しません。';
$string['validators:signup.tandc.mustagree'] = 'MoodleCloudを利用するにはあなたは利用規約に同意する必要があります。';
$string['validators:signup.timezone.mustselect'] = 'あなたのタイムゾーンを選択してください。';
$string['validators:site.firstname.mustexist'] = 'あなたの名を入力する必要があります。';
$string['validators:site.lastname.mustexist'] = 'あなたの姓を入力する必要があります。';
$string['validators:site.subdomain.format'] = 'サブドメインは半角英字で開始してください。これには半角英数字およびハイフンのみ含んでください。';
$string['validators:site.subdomain.maxlength'] = 'サブドメインは半角53文字以内にしてください。';
$string['validators:site.subdomain.minlength'] = 'サブドメインは少なくとも半角3文字にする必要があります。';
$string['validators:site.subdomain.mustexist'] = 'あなたはサブドメインを入力する必要があります。';
