...
/**
 * Strings for component 'qbank_statistics', language 'ja', version '4.1'.
 *
...
$string['discriminative_efficiency_help'] = '判別効率は問題がどの程度学生を評価するかについての統計的推定値であり、値が高いほど優れています。特に低い値は問題に問題があることを示している場合があります。非常に難しい問題または簡単な問題 (ファシリティ指数が0%または100%に近い) も低い値になる場合があります。';
$string['discriminative_efficiency_link'] = 'mod/quiz/statistics';
$string['emptyvalue'] = '-';
$string['facility_index'] = 'ファシリティ指標';
$string['facility_index_help'] = 'ファシリティ指数はその問題が受験されたすべての小テストで取得された平均点 (パーセンテージ) を示します。通常、高い値はより簡単な問題であることを示します。';
