...
/**
 * Strings for component 'quizaccess_seb', language 'ja', version '4.1'.
 *
...
$string['seb_linkquitseb_help'] = 'あなたはこのフィールドにSEBを終了するためのリンクを入力できます。これは小テストが送信された後に表示されるページ上の「Safe Exam Browserを終了する」ボタンに使用されます。ボタンをクリックした場合、またはあなたが好きな場所に設置したリンクをクリックした場合、終了パスワードを入力せずにSEBを終了できます。リンクが入力されない場合、「Safe Exam Browserを終了する」ボタンは表示されません。また、SEBを終了するリンクは設定されません。';
