...
/**
 * Strings for component 'theme_adaptable', language 'ja', version '4.1'.
 *
...
$string['menuhovercolor'] = 'メインメニューホバー色';
$string['menuhovercolordesc'] = 'メインメニューホバー色を設定します。';
...
$string['newmenu1trigger'] = 'トップメニュードロップダウン1トリガーワード';
$string['newmenu1triggerdesc'] = 'トップメニュードロップダウン1のトリガーワードを設定します。Font Awesomeアイコンを使用できます。';
$string['newmenu2trigger'] = 'トップメニュードロップダウン2トリガーワード';
$string['newmenu2triggerdesc'] = 'トップメニュードロップダウン2のトリガーワードを設定します。Font Awesomeアイコンを使用できます。';
...
$string['toolsmenu2'] = '第2ツールメニュー';
$string['toolsmenu2desc'] = 'あなたはツールメニューの下に表示されるリンクを設定できます。それぞれの行はパイプ文字で区切られたメニューテキスト、リンクURL (任意)、ツールチップタイトル (任意)、言語コードまたはカンマ区切りのコードのリスト (任意、指定された言語のユーザにのみ行を表示するため) で構成されます。あなたはハイフンを使用して構造を指定できます。例えば次のようになります: <pre> Moodle community|https://moodle.org -Moodle free support|https://moodle.org/support -Moodle development|https://moodle.org/development --Moodle Docs|http://docs.moodle.org|Moodle Docs --German Moodle Docs|http://docs.moodle.org/de|Documentation in German|de Moodle.com|http://moodle.com/ </pre>';
...
$string['toolsmenulabel'] = 'ツールメニュー';
$string['toolsmenulabel2'] = 'ツール2';
