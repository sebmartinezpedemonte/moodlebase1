...
/**
 * Strings for component 'tool_dynamicrule', language 'ja', version '4.1'.
 *
...
$string['conditioncompetencyselector_help'] = 'コンピテンシーを選択すると、そのコンピテンシーを達成したユーザーを検索できます';
...
登録方法: \'{$a->enrol}\'';
$string['conditionuserenrolleddescriptionwithdate'] = 'コース \'{$a->course}\' に登録されているユーザー<br />
登録方法: \'{$a->enrol}\'<br />
登録開始日以降 \'{$a->conditiondate}\'';
$string['conditionuserfirstlogindescriptionever'] = '初回ログインが一度でもあるユーザー';
...
$string['conditionuserprofilefielddescription'] = 'プロファイルフィールド \'{$a->fieldname}\' の値が \'{$a->fieldvalue}\' であるユーザー';
$string['conditionuserprofilefielddescriptiontext'] = 'プロファイルフィールド \'{$a->fieldname}\' の値が {$a->fieldvalue} であるユーザー';
...
$string['confirmeditrule'] = '過去にこのルールにマッチしたユーザーがいるため、ルールのアクションのみ編集可能です。条件を変更するためにはこのルールを複製してください。';
$string['confirmenablecomponentrule'] = '本当にこのルールを有効にしますか？有効にすると {$a} ユーザーに影響します。';
$string['confirmenablerule'] = '少なくとも1人のユーザーがこのルールの影響を受けると、条件がロックされます。本当にこのルールを有効にしますか？';
...
$string['creationdate_help'] = '指定した期間内に作成されたユーザーをマッチさせるために、現在の日付からの相対的な日付を選択することができます。';
...
$string['errorcohortnotamember'] = 'ユーザーがこのコーホートのメンバーでないため、ユーザーをコーホートから削除できません。';
...
$string['errorinvalidoperator'] = '無効な演算子。前後のみが許可されます。';
...
$string['firstlogin_help'] = '設定された期間内または現在の日付に関連する期間に初めてログインしたユーザー、および任意の時点で初めてログインしたユーザー、または一度もログインしたことがないユーザーを選択できます。';
$string['general'] = '一般';
...
$string['includesuspendedusers_help'] = 'チェックした場合、ルールはこのサイトでアカウントが停止されたユーザーに対しても条件を判断し、マッチしたすべてのユーザーにアクションを適用しようとします。例えば、通知を受け取らないなどです。';
$string['lastlogin'] = 'ユーザの最終ログイン';
$string['lastlogin_help'] = '現在の日付からの相対的な日付、または一度もログインしていないユーザーを選択できます。';
...
$string['placeholdersdesc_help'] = '例えば、 {{userfullname}} プレースホルダはユーザーに配信される通知の中でユーザーのフルネームに置き換えられます。';
$string['pluginname'] = 'ダイナミックルール';
$string['previewcoursefullname'] = 'コースフルネーム';
$string['previewcourseshortname'] = 'コース省略名';
$string['privacy:metadata:tool_dynamicrule_match'] = '特定のルール条件にマッチするユーザーに関する情報。マッチングの結果、ユーザはルールで定義されたアクションの影響を受けます。';
$string['privacy:metadata:tool_dynamicrule_match:matchedtime'] = 'ユーザーがルール条件にマッチしたことを示すタイムスタンプ';
$string['privacy:metadata:tool_dynamicrule_match:ruleid'] = 'ルールのID';
$string['privacy:metadata:tool_dynamicrule_match:unmatchedtime'] = 'アクションが適用された後、ユーザーがルール条件に一致しなくなったことを示すタイムスタンプ';
$string['privacy:metadata:tool_dynamicrule_match:userid'] = 'ルール条件にマッチしたユーザーのID';
...
$string['rulematchfreq_help'] = 'ユーザーがルール条件に一致すると、すぐにアクションが適用されます。ユーザーが引き続き条件に一致する場合、これらのアクションは再度適用されません。ただし、ユーザーが条件に一致しなくなった後、再び条件に一致した場合は、アクションが再び適用されることがあります。この設定は、アクションの最大適用回数を定義します。';
$string['rulematchfreqdesc0'] = 'これ以上の適用はできません';
$string['rulematchfreqdesc1'] = '時間';
$string['rulematchfreqenable'] = '各ユーザーにアクションを適用する回数を制限する';
$string['rulename'] = '名前';
...
$string['warningchangeswillnotapplymatchedusers'] = 'この変更は、過去にこのルールに合致したユーザーには適用されません。';
