...
/**
 * Strings for component 'tool_moodlenet', language 'ja', version '4.1'.
 *
...
$string['autoenablenotification'] = '<p>Moodle 4.0以降、<a href="https://moodle.net/">MoodleNet</a>インテグレーションが拡張機能でデフォルトで有効にされています。活動の作成および管理するケイパビリティのあるユーザは活動チューザからMoodleNetを閲覧してMoodleNetリソースをコースにインポートできます。</p><p>必要であれば、<a href="{$a->settingslink}">MoodleNet設定</a>で別のMoodleNetインスタンスを指定できます。</p>';
