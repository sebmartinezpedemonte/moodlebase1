...
/**
 * Strings for component 'customfield_textregex', language 'pt', version '4.1'.
 *
...
$string['regex_help'] = 'Expressão regular de estilo Perl para testar o valor do campo. Inclua também os delimitadores. Por exemplo: \\"/^TEST[0-9A-F]{3}\\/\\$_postfjx/\\".';
