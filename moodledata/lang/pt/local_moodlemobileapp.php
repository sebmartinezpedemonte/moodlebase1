...
/**
 * Strings for component 'local_moodlemobileapp', language 'pt', version '4.1'.
 *
...
$string['core.login.changepasswordlogoutinstructions'] = 'Se pretender alterar o site ou sair, clique no botão a seguir:';
...
$string['core.login.faqcannotconnectquestion'] = 'Digitei o endereço do meu site corretamente mas ainda não consigo entrar.';
...
$string['core.login.helpmelogin'] = '<p>Existem muitos milhares de sites Moodle em todo o mundo. Esta aplicação só pode ligar-se a sites Moodle que ativaram especificamente o acesso a aplicações para dispositivos móveis.</p><p>Se não conseguir ligar-se ao seu site Moodle, contacte o administrador do site e peça-lhe para consultar <a href="http://docs.moodle.org/en/Mobile_app" target="_blank">http://docs.moodle.org/en/Mobile_app</a>.</p><p>Para testar a aplicação num site de demonstração do Moodle digite <i>teacher</i> ou <i>student</i> no campo <i>Endereço do site</i> e depois clique no botão <b>Ligar</b>.</p >';
...
$string['core.login.reconnectssodescription'] = 'A sua sessão expirou. Tem de autenticar-se no site através de uma janela do navegador.';
...
$string['freemium.autologoutclosingtheapp'] = 'Imediatamente após após sair da aplicação';
$string['freemium.autologoutcustomtime'] = 'Temporização personalizada após sair da aplicação';
$string['freemium.autologoutdefault'] = 'Predefinição';
$string['freemium.autologouttitle'] = 'Terminar sessão automaticamente neste dispositivo';
...
$string['freemium.settingsoptions_autologout'] = 'Fim de sessão automática';
