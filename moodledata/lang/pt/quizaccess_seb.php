...
/**
 * Strings for component 'quizaccess_seb', language 'pt', version '4.1'.
 *
...
$string['seb_linkquitseb_help'] = 'Neste campo, pode inserir a hiperligação para sair do SEB. Será usada no botão "Sair do Safe Exam Browser" na página exibida após a submissão do teste. Ao clicar no botão ou na hiperligação colocada onde pretende, é possível sair do SEB sem precisar digitar uma senha. Se nenhuma hiperligação for indicada, o botão "Sair do Safe Exam Browser" não aparecerá e não haverá uma hiperligação definida para sair do SEB.';
