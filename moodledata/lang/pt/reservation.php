...
/**
 * Strings for component 'reservation', language 'pt', version '4.1'.
 *
 * @package     reservation
 * @category    string
...
$string['cancellersmail'] = 'Está cancelado na reserva \'{$ a-> reservation}\'.';
$string['cancellersmailhtml'] = 'Está cancelado na reserva <em>{$a->reservation}</em>.';
...
$string['crontask'] = 'Enviar reserva e solicitar e-mails de avaliação';
...
$string['err_notimestart'] = 'A da de início do evento não está definida';
...
$string['noterequired'] = 'Observação obrigatória. Insira aqui antes de reservar.';
$string['notgraded'] = 'Não avaliado';
$string['notifies'] = 'Notificações a enviar';
$string['notifycancellers'] = 'Notificar os canceladores quando o cancelamento de reserva foi efetuado com sucesso';
$string['notifygrades'] = 'Notificar os alunos acerca das reserva avaliadas';
$string['notifyoverbookers'] = 'Notificar os alunos que fizeram reservas em sobrelotação quando estas se tornarem reservas sem lista de espera';
$string['notifyreservers'] = 'Notificar quem reservou quando o pedido de reserva for bem-sucedido';
...
$string['notreserved'] = 'Não reservada';
...
$string['reservation:manage'] = 'Pode gerir reservas';
...
$string['reservation:view'] = 'Pode visualizar reservas';
...
$string['reserversmail'] = 'Tem reserva em \'{$a->reservation}\'.';
$string['reserversmailhtml'] = 'Tem reserva em <em>{$a->reservation}</em>.';
...
$string['status'] = 'Estado de reserva';
