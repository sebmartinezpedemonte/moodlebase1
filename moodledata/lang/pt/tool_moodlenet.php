...
/**
 * Strings for component 'tool_moodlenet', language 'pt', version '4.1'.
 *
...
$string['autoenablenotification'] = '<p>Desde o Moodle 4.0 em diante, a integração do <a href="https://moodle.net/">MoodleNet</a> está ativada por predefinição nas rfuncionalidades avançadas. Os utilizadores com a capacidade de criar e gerir atividades podem navegar no MoodleNet através do seletor de atividades e importar recursos do MoodleNet para as suas disciplinas.</p><p>Se desejar, uma instância alternativa do MoodleNet pode ser especificada nas <a href="{$a->settingslink}">Configurações do MoodleNet</a>.</p>';
...
$string['enablemoodlenet'] = 'Ativar a integração do MoodleNet';
...
$string['moodlenetsettings'] = 'Configurações do MoodleNet';
