...
<li>Если  в качестве IdP используется Azure AD, то дополнительные данные профиля можно сделать доступными, установив и настроив <a href="https://moodle.org/plugins/local_o365">подключаемый модуль интеграции Microsoft 365 (local_o365)</a>.</li>
