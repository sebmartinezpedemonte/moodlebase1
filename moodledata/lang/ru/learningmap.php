...
/**
 * Strings for component 'learningmap', language 'ru', version '4.1'.
 *
 * @package     learningmap
 * @category    string
...
$string['showdescription'] = 'Показать карту на странице курса';
$string['showdescription_help'] = 'Если флажок установлен, то карта обучения будет отображаться на странице курса (как Пояснение). Иначе будет ссылка и карта будет отображаться на отдельной странице.';
