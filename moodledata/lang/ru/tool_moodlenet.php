...
/**
 * Strings for component 'tool_moodlenet', language 'ru', version '4.1'.
 *
...
$string['autoenablenotification'] = '<p>В Moodle 4.0 и более поздних версиях интеграция с <a href="https://moodle.net/">MoodleNet</a> включена по умолчанию в расширенных функциях. Пользователи, имеющие возможность создавать активные элементы и управлять ими, могут просматривать MoodleNet через средство выбора элементов и импортировать ресурсы MoodleNet в свои курсы.</p><p>При желании альтернативный экземпляр MoodleNet можно указать в разделе <a href="{$a->settingslink}">Настройки MoodleNet</a>.</p>';
